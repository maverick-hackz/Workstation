...
| [cors.md](./cors.md) | [WSTG-CLNT-07](https://owasp.org/www-project-web-security-testing-guide/v42/4-Web_Application_Security_Testing/11-Client-side_Testing/07-Testing_Cross_Origin_Resource_Sharing) | — |
...
| [jwt-attacks.md](./jwt-attacks.md) | [WSTG-SESS-10](https://github.com/OWASP/wstg/blob/master/document/4-Web_Application_Security_Testing/06-Session_Management_Testing/10-Testing_JSON_Web_Tokens.md) | — |
...
| [upload-bypass.md](./upload-bypass.md) | [WSTG-BUSL-08](https://owasp.org/www-project-web-security-testing-guide/v42/4-Web_Application_Security_Testing/10-Business_Logic_Testing/08-Test_Upload_of_Unexpected_File_Types) | [T1505.003 Web Shell](https://attack.mitre.org/techniques/T1505/003/) |
